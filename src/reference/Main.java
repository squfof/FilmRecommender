...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //System.out.println(thomas + " recommender: " + ref.findRecommender(thomas));
        //System.out.println(mikke + " recommender: " + ref.findRecommender(mikke));
        //System.out.println(matti + " recommender: " + ref.findRecommender(matti));
        //System.out.println(pekka + " recommender: " + ref.findRecommender(pekka));
